...
import com.alice.moviesv.object_models.Movie;
import com.alice.moviesv.object_models.Rating;
import com.alice.moviesv.object_models.Trailer;
import com.alice.moviesv.provider.MovieContract;
import com.alice.moviesv.provider.MovieProvider;
import com.alice.moviesv.util.MyDebug;
import com.alice.moviesv.util.FileHelper;
import com.alice.moviesv.util.TMDB_ApiHandler;
...
public class MovieDetailFragment extends Fragment implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        else mMovie = new com.alice.moviesv.object_models.Movie("","",0,"","","","");
    ...
    public void onAttach(Context context) {
        if (DEBUG) MyDebug.LOGD(TAG, "onAttach");
    ...
    public void onClick(View v) {
        if (DEBUG) MyDebug.LOGD(TAG,"FAB clicked");
        ...
        if (mIsFavorite) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (DEBUG) MyDebug.LOGD(TAG, "item inserted into db at:" + newFavoriteUri.toString());
    ...
    private class TrailerAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            String data = null;
            try {
                if (DEBUG) MyDebug.LOGD(TAG, "doInBackground...");
        ...
        protected void onPostExecute(String result) {
            ...
            if (DEBUG) MyDebug.LOGD(TAG, "onPostExecute(" + result + ")");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int i=0; i<ratingsCount; i++) {
                    ...
                    if (DEBUG) MyDebug.LOGD(TAG, "rating found:" + ratingData.toString());
    ...
    private class DetailsAdapter extends ArrayAdapter {
        ...
        private View getTrailerView(int position, View convertView, ViewGroup parent) {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (DEBUG) MyDebug.LOGD(TAG,"trailer:" + thisTrailer.id + " clicked");
        ...
        private View getRatingsView(int position, View convertView, ViewGroup parent) {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (DEBUG) MyDebug.LOGD(TAG,"rating:" + thisRating.id + " clicked");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId()==OptionMenu_ShareTrailer) {
            ...
            if (DEBUG) MyDebug.LOGD(TAG, "Sharing trailer:" + videoUrl);
